...
public:
    ZoomControlNode() : Node("zoom_control_node"), zoom_level_(declare_parameter<int>("initial_zoom", 0)), reset_on_start_(declare_parameter<bool>("reset_to_1x_on_start", true)) {
